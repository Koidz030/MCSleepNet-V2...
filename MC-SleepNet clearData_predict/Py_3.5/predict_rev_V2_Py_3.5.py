...
tf.app.flags.DEFINE_string('data_dir', "/data2/clearData20190330", # sys.argv[1],
                           """Directory where to load training data.""")
tf.app.flags.DEFINE_string('model_dir', "/home/juan/model_epoch19.ckpt-20", #"/home/ota/cross_1/fold1/deepsleepnet/model_epoch19.ckpt-20", #"/home/ota/cross_1/fold1/deepsleepnet/params_epoch19.npz", #sys.argv[2],
                           """Directory where to load trained models.""")
...
def custom_run_epoch(
    ...
    for sub_f_idx, each_data in enumerate(itertools.zip_longest(inputs[0],inputs[1], targets)):
...
def predict(
    ...
    for fold_idx in range(n_subjects//n_subjects_per_fold):
        ...
        with tf.Graph().as_default(), tf.Session() as sess:
            ...
            print("valid_net.name: "+str(valid_net.name))
            ...
            checkpoint_path = "/home/juan/model_epoch19.ckpt-20"
            ...
            # Load trained model
            #trained_model_path = "/home/ota/cross_1/fold1/deepsleepnet/params_epoch19.npz"
